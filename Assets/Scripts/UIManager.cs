...
public class UIManager : MonoBehaviour
{
    ...
    public TextMeshProUGUI leftAnswerText; // Texto do bot�o Aceitar
    public TextMeshProUGUI rightAnswerText; // Texto do bot�o Recusar
    ...
    [Header("Configura��es")]
    public float animationSpeed = 2f; // Velocidade da anima��o das barras
    ...
    public void ShowGameOver(string reason)
    {
        ...
        // Implemente sua l�gica de tela de game over aqui
    }
    ...
    public void LeftAnswerButton()
    {
        if (!GameManager.instance.onTutorial)
        {
            ...
            GameManager.instance.ChooseLeft(GameManager.instance.actualDeck[0]);
